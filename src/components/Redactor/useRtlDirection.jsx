...
useData.propTypes = {
  ...
  /** method for adding a new note to the database. Creates an empty note and stores it in the database. Accepts a note title and content as an optional parameter.  */
